...
- This file implements the k-means algorithm from scrach.
'''
...
centers = [ center for center in cl.cluster_centers_] # cluser centers: each center is a mean of cluster points 
